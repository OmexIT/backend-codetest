...
This take‑home mirrors the JS coding challenge but in Java. You will build the bag counting logic and ensure all tests pass.

## What to implement
- Complete `GetBagCounts.getBagCounts` to calculate how many seed bags of each available size are needed per the provided requirements (see inline Javadoc).
